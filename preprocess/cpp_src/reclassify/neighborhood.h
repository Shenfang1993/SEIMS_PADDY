...
template<class elemType>
inline bool GPRO::Neighborhood<elemType>::
...
template<class elemType>
inline GPRO::WeightedCell<elemType> &GPRO::Neighborhood<elemType>::
operator[](int iNbr)
{
...
template<class elemType>
inline const GPRO::WeightedCell<elemType> &GPRO::Neighborhood<elemType>::
...
template<class elemType>
inline GPRO::Neighborhood<elemType> &GPRO::Neighborhood<elemType>::
...
template<class elemType>
inline int GPRO::Neighborhood<elemType>::
size() const
{
    return _vNbrs.size();
}
...
template<class elemType>
inline const GPRO::CoordBR &GPRO::Neighborhood<elemType>::
getMBR() const
{
    return _MBR;
}
...
template<class elemType>
inline const GPRO::IntVect *GPRO::Neighborhood<elemType>::
           ...
           Neighborhood<elemType> &nbrhood)
{
    ...
    if (nNbrs >= 100)
    {
        int size = (int) sqrt((double) nNbrs);
        int isize = size / 2;
