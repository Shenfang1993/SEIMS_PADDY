...
#pragma omp parallel for
	...
	/*cout<<"NUTR_QUAL2E, surNO3ToCh: "<<m_surNO3ToCh[5]<<", gwno3ToCh: "<<m_gwNO3ToCh[5]<<", ptNo3ToCh: "<<m_ptNO3ToCh[5]
	<<", chOutNO3: "<<m_chOutNO3[5]<<", chOutNO3Conc: "<<m_chOutTNConc[5]<<", TN: "<<m_chOutTN[5]<<", TNConc: "<<m_chOutTNConc[5]<<endl;
	cout<<"chStr_NO3: "<<m_chNO3[5]<<", chStr_NH4: "<<m_chNH4[5]<<", chStr_TN: "<<m_chTN[5]<<endl;*/
    return 0;
}
