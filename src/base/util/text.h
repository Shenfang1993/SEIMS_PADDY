...
#define MID_RICEGROW                        "RiceGrow"
#define MDESC_RICEGROW                      "Calculte rice growth using method of ORYZA"
...
#define DESC_POT_VOLUPMM "max fit volume of water stored in the depression/impounded area"
...
#define DESC_IRRDEPTH "irrigate depth which should remove from nearst pond and reach"
